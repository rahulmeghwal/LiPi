...
------------------------------------------------------------------------------------------------------------
For details of the syntax of a LiPi script you can refer to the documentation given in LiPi.pdf

This project was created by me(rahulmeghwal.rm@gmail.com) and my friend Yashwant Rathore (yashrr@gmail.com).
